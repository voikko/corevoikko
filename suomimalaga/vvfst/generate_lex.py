...
def handle_word(word):
	...
	for altform in generate_lex_common.tValues(word.getElementsByTagName("forms")[0], "form"):
		...
		if vfst_word_class == u"[Lh]":
			...
			continue
		if jatko not in [u"valo", u"alku", u"luku", u"ruoko", u"aalto", u"anto", u"lintu", u"hanko", u"hattu", u"liitto", u"hinku", u"tiuku", u"hoppu", u"kaarto", u"kippo", u"sampo", u"kumpu", u"laatu", \
