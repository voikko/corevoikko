...
words = [u"aikalainen", u"alaisuus",
	 ...
	 u"kansalainen", u"kansallismielinen", u"kuntalainen", u"kurssilainen",
	 u"kymmenvuotinen",
	 u"kyyhkyläinen",
	 ...
	 u"käynti",
	 u"laajakaista", u"laajakangas", u"laajakulma", u"laajakuva", u"lahkolainen", u"lahopuu",
	 u"lahtelainen", u"laulattaa", u"leniniläinen", u"liittolainen", u"lojaalisuus",
	 u"luokkalainen", u"luontoistalous", u"lyönti",
	 u"maallistua", u"maolainen", u"marxilainen", u"mongolilainen", u"mäkitupalainen",
	 u"nimismies",
	 u"ohutsuoli", u"oikeistolainen", u"oikeus", u"opetus", u"otto",
         u"pakolainen", u"pito", u"platonilainen", u"poltto",
	 ...
	 u"Terho", u"Terttu", u"Tikka", u"Timpuri", u"Toivo",
