...
[perusmuoto: "rykimäaika", alku: "rykimäa", luokka: nimisana, jatko: <aika>, äs: a, tiedot: <inen>, rakenne: "=pppppp=pppp"];
...
[perusmuoto: "Ka", alku: "Ka", luokka: nimi, jatko: <loppu, omanto_n, sisätulento_hVn>, äs: a, tiedot: <ei_ys>];
...
[perusmuoto: "valmisruoka", alku: "valmisru", luokka: nimisana, jatko: <ruoka>, äs: a, rakenne: "=pppppp=ppppp", tiedot: <ei_sukija>];
