...
[perusmuoto: "tuntea", alku: "tuta", luokka: teonsana, jatko: <loppu>, äs: a, tiedot: <ei_sukija>];    # Vain nämä muodot ovat yleisessä käytössä.
[perusmuoto: "tuntea", alku: "tutaan", luokka: teonsana, jatko: <loppu>, äs: a, tiedot: <ei_sukija>];  # Tuttu ja tuttava tajutaan eri sanoiksi.
