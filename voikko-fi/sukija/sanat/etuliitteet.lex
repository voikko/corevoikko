...
[perusmuoto: "eri", alku: "eri", luokka: etuliite, jatko: @eln + @ell + @elt, äs: aä];
...
[perusmuoto: "peri", alku: "peri", luokka: etuliite, jatko: @ell + @eln, äs: aä];
...
[perusmuoto: "ääreis", alku: "ääreis", luokka: etuliite, jatko: @eln + @ell, äs: aä, tiedot: <ei_sukija>];
