...
# pienellä alkukirjaimella "sydän- ja verisuonitaudit"-tyyppisissä rakenteissa.
 [perusmuoto: "etelä-", alku: "etelä-", luokka: nimisana, etuliite: yes, jatko: <loppu>, äs: aä, rakenne: "=ppppp-", tiedot: <ei_sukija>];
 [perusmuoto: "iso-", alku: "iso-", luokka: nimisana, etuliite: yes, jatko: <loppu>, äs: aä, rakenne: "=ppp-", tiedot: <ei_sukija>];
 [perusmuoto: "itä-", alku: "itä-", luokka: nimisana, etuliite: yes, jatko: <loppu>, äs: aä, rakenne: "=ppp-", tiedot: <ei_sukija>];
 [perusmuoto: "kanta-", alku: "kanta-", luokka: nimisana, etuliite: yes, jatko: <loppu>, äs: aä, rakenne: "=ppppp-", tiedot: <ei_sukija>];
 [perusmuoto: "keski-", alku: "keski-", luokka: nimisana, etuliite: yes, jatko: <loppu>, äs: aä, rakenne: "=ppppp-", tiedot: <ei_sukija>];
