...
#ifndef VOIKKO_SPELLCHECKER_SUGGESTION_SUGGESTION_GENERATOR_SPLIT_WORD_H
#define VOIKKO_SPELLCHECKER_SUGGESTION_SUGGESTION_GENERATOR_SPLIT_WORD_H
...
class SuggestionGeneratorSplitWord : public SuggestionGenerator {
	public:
		explicit SuggestionGeneratorSplitWord(morphology::Analyzer * morAnalyzer);
