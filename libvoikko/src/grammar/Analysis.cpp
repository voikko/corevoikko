 ...
 *  been set. */
void Analysis::analyse_token(voikko_options_t * voikkoOptions, Token * token) {
	wchar_t * wordBuffer =
...
Sentence * Analysis::analyse_sentence(voikko_options_t * voikkoOptions,
...
Paragraph * Analysis::analyse_paragraph(voikko_options_t * voikkoOptions, const wchar_t * text, size_t textlen) {
