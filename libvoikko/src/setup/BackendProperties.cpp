...
BackendProperties::BackendProperties(const BackendProperties & props) :
	path(props.path),
	backend(props.backend),
	advertised(props.advertised) {
}

const string & BackendProperties::getPath() const {
	return path;
}

const string & BackendProperties::getBackend() const {
	return backend;
}

bool BackendProperties::isAdvertised() const {
	return advertised;
}
