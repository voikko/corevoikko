...
def getPortlet():
	...
	html = html + u"<ul><li><a href='#tabDirect'>Kirjoita teksti</a></li><li><a href='#tabPage'>Oikolue www-sivu <span style='color: red'>(beta)</span></a></li>"
	html = html + u"<li><a href='#tabInfo'>Tietoja palvelusta</a></li></ul>"
	...
	html = html + u"</div>"
	html = html + u"<div id='tabInfo'>"
	html = html + u"<p>Webvoikko on ilmainen oikolukupalvelu. Tekstin analyysissä käytetään seuraavia korostusmerkintöjä:</p><ul>"
	html = html + u"<li><span class='word'>virheetön</span>: Oikein kirjoitettu. Sanan napsauttaminen antaa tietoja sanan rakenteesta.</li>"
	html = html + u"<li><span class='word error'>kirjoitusvihre</span>: Virheellinen sana. Sanan napsauttaminen antaa sanalle korjausehdotuksia.</li>"
	html = html + u"<li><span class='gErrorOuter'><span class='gErrorHandle'>✗</span><span class='gErrorInner'>kielioppivirhe</span></span>: Tarkistusmerkin napsauttaminen näyttää selityksen virheelle.</li></ul>"
	html = html + u"<p>WWW-sivujen oikoluvussa käytetään lisäksi seuraavia reunamerkintöjä:</p>"
	html = html + u"<p class='webvoikkoP'>Tekstikappaleeksi tunnistettu osuus, jonka kielioppi tarkistetaan.</p>"
	html = html + u"<p class='webvoikkoO'>Muu kuin kappaleeksi tai luetteloksi tunnistettu tekstiosuus. Kielioppi tarkistetaan rajoitetusti.</p>"
	html = html + u"<small>Webvoikko © Harri Pitkänen (hatapitk@iki.fi) 2009 – 2014</small>"
	html = html + u"</div>"
	html = html + u"</div>"
